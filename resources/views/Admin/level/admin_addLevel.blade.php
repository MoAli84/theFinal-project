                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/level') }}"
                                        method="POST">
                                        @csrf
                                        @method('post')

                                        <div class="form-group">
                                            <label for="exampleInputNationality"> Academic Stage</label>
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality"
                                                name="EduLevelName" value="{{ old('EduLevelName') }}"
                                        ...
                                        <a href="{{ url('admin/index/level') }}"> <button type="button"
