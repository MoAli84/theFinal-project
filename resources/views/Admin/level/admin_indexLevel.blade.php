                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-8 grid-margin">
                                    <p class="card-description" style="margin: 20px;">
                                        <a href="{{ url('admin/create/level') }}"> <button type="button"
                                                class="btn btn-primary"> Add Academic Level</button></a>
                                    </p>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $lev)
                                                    <td>{{ $lev->id }} </td>
                                                    <td>{{ $lev->EduLevelName }} </td>

                                                    <td>

                                                        <a href="{{ url('admin/edit/level/' . $lev->id) }}"> <button
                                                                type="button" class="btn btn-primary"
                                                                style="margin-right: 10px;"> Edit</button></a>

                                                        <a data-toggle="modal"
                                                            data-target="#modal_single_del{{ $lev->id }}"
                                                    ...
                                                    <div class="modal" id="modal_single_del{{ $lev->id }}"
