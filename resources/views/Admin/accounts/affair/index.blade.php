                            ...
                            <div class="card">
                                ...
                                <p class="card-description" style="margin: 20px;">
                                    <a href="{{ url('admin/register') }}"> <button type="button"
                                            class="btn btn-secondary">Create Student_Affair Account</button></a>
                                </p>
                                <div class="row">
                                                ...
                                                <tbody>
                                                  ...
                                                  <td>{{ '0'. $x->phone }} </td> --}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('affair/show/staff/' . $x->id) }}">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('affair/delete/accou/' . $x->id) }}"
                                                                            method="post">
