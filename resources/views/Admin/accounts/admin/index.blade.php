            ...
            {{-- {{ auth()->guard('admins')->user()->fullName }} --}}
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                              ...
                              {{-- <p style="text-align:center"> welcome , {{ auth()->guard('admins')->user()->fullName }}</p> --}}
                                <p class="card-description" style="margin: 20px;">
                                    <a href="{{ url('admin/register') }}"> <button type="button"
                                            class="btn btn-dark">Create Admin Account</button></a>
                                </p>
                                <div class="row">
                                                ...
                                                <tbody>
                                                  ...
                                                  <td>{{'0'. $x->phone }} </td> --}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('admin/show/staff/' . $x->id) }}"> <button
                                                                    type="button" class="btn btn-info"
                                                                    style="margin-right: 10px;"> Show</button></a>

                                                            <a data-toggle="modal"
                                                                data-target="#modal_single_del{{ $x->id }}"
                                                        ...
                                                        <div class="modal" id="modal_single_del{{ $x->id }}"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('admin/delete/accou/' . $x->id) }}"
                                                                            method="post">
