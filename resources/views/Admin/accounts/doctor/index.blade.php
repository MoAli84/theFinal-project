                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="primary">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ url('affair/index/staff') }}">Entry Officer</a></li>
                                <li class="nav-item"> <a class="nav-link"
                            ...
                            <div class="card">
                                ...
                                <p class="card-description" style="margin: 20px;">
                                    <a href="{{ url('admin/register') }}"> <button type="button"
                                            class="btn btn-info">Create Doctor Account</button></a>
                                </p>
                                <div class="row">
                                                ...
                                                <tbody>
                                                  ...
                                                  <td>{{ $x->phone }} </td> --}}
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('doctor/show/staff/' . $x->id) }}">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('doctor/delete/accou/' . $x->id) }}"
                                                                            method="post">
