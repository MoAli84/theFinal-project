                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-8 grid-margin">
                                    <p class="card-description" style="margin: 20px;">
                                        <a href="{{ url('admin/create/nationality') }}"> <button type="button"
                                                class="btn btn-primary"> Add Nationality</button></a>
                                    </p>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $nation)
                                                    ...
                                                    <td>
                                                        ...
                                                        <a
                                                            href="{{ url('admin/edit/nationality/' . $nation->id) }}">
                                                            <button type="button" class="btn btn-primary"
                                                                style="margin-right: 10px;"> Edit</button></a>

                                                        <a data-toggle="modal"
                                                            data-target="#modal_single_del{{ $nation->id }}"
                                                    ...
                                                    <div class="modal" id="modal_single_del{{ $nation->id }}"
