                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/store/year') }}"
                                        method="POST">
                                        @csrf
                                        @method('post')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="text" pattern="^(20)\d{2}$" maxlength="4"
                                                class="form-control" id="exampleInputYear" name="year"
                                        ...
                                        <a href="{{ url('admin/index/year') }}"> <button type="button"
