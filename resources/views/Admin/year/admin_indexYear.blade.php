                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-8 grid-margin">
                                    <p class="card-description" style="margin: 20px;">
                                        <a href="{{ url('admin/create/year') }}"> <button type="button"
                                                class="btn btn-primary"> Add Year</button></a>
                                    </p>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $y)
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/edit/year/' . $y->id) }}"> <button
                                                                type="button" class="btn btn-primary"
                                                                style="margin-right: 10px;"> Edit</button></a>

                                                        <a data-toggle="modal"
                                                            data-target="#modal_single_del{{ $y->id }}"
                                                    ...
                                                    <div class="modal" id="modal_single_del{{ $y->id }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('admin/delete/year/' . $y->id) }}"
                                                                        method="post">
