                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/town') }}"
                                        method="POST">
                                        @csrf
                                        @method('post')
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputNationality">Town</label>
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality"
                                                name="TownName" value="{{ $data->TownName }}" placeholder="Town">

                                        </div>

                                        <button type="submit" class="btn btn-primary mr-2">Add</button>
                                        <a href="{{ url('admin/index/town') }}"> <button type="button"
