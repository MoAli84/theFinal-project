                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-8 grid-margin">
                                    <p class="card-description" style="margin: 20px;">
                                        <a href="{{ url('admin/create/district') }}"> <button type="button"
                                                class="btn btn-primary"> Add District</button></a>
                                    </p>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $p)
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('admin/edit/district/' . $p->Id) }}">
                                                            <button type="button" class="btn btn-primary"
                                                                style="margin-right: 10px;"> Edit</button></a>

                                                        <a data-toggle="modal"
                                                            data-target="#modal_single_del{{ $p->Id }}"
                                                    ...
                                                    <div class="modal" id="modal_single_del{{ $p->Id }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('admin/delete/district/' . $p->Id) }}"
                                                                        method="post">
