                            ...
                            <div class="row">
                                ...
                                <div class="card col-md-8 grid-margin">
                                    <p class="card-description" style="margin: 20px;">
                                        <a href="{{ url('admin/create/sublevel') }}"> <button type="button"
                                                class="btn btn-primary"> Add Sub_Level</button></a>
                                    </p>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $sub)
                                                    <td>{{ $sub->id }} </td>
                                                    <td>{{ $sub->EduLevelName }} </td>
                                                    <td>{{ $sub->SubLevelName }} </td>

                                                    <td>

                                                        <a href="{{ url('admin/edit/sublevel/' . $sub->id) }}">
                                                            <button type="button" class="btn btn-primary"
                                                                style="margin-right: 10px;"> Edit</button></a>

                                                        <a data-toggle="modal"
                                                            data-target="#modal_single_del{{ $sub->id }}"
                                                    ...
                                                    <div class="modal" id="modal_single_del{{ $sub->id }}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">Delete...!<br>
                                                                    <div class="alert-danger p-3 m-3">
                                                                        {{ $sub->SubLevelName . '  ' . $sub->EduLevelName }}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('admin/delete/sublevel/' . $sub->id) }}"
                                                                        method="post">
