                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ url('admin/update/sublevel') }}"
                                        method="POST">
                                        @csrf
                                        @method('post')
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelectReligion">Academic Level</label>
                                            <select class="form-control" name="LevelId" style="width: 50%;">
                                                @foreach ($le as $info)
                                                    <option value="{{ $info->id }}"
                                                        @if ($data->LevelId == $info->id) selected @endif>
                                                        {{ $info->EduLevelName }}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputNationality">Sub Level</label>
                                            <br>
                                            <input type="text" class="form-control" id="exampleInputNationality"
                                                name="SubLevelName" value="{{ $data->SubLevelName }}"
